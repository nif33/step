...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeIsBusy() {
    // Have the optional attendee be ignored because they are busy all day
  ...
  public void optionalAttendeeIsAvailable() {
    // Have the optional attendee considered into the meeting time
  ...
  public void notEnoughRoomForOptional() {
    // Have optional attendee be ignored since the time slot is too small
  ...
  public void optionalAttendeesOnlyAvailable() {
    // Have only optional attendees, who are available to meet at the same time
  ...
  @Test
  public void optionalAttendeesOnlyUnavailable() {
    // Have only optional attendees, who are unavailable to meet at the same time

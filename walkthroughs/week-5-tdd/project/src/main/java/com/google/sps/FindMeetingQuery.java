...
public final class FindMeetingQuery {
  ...
  public Collection<TimeRange> query(Collection<Event> events, MeetingRequest request) {
    ...
    Collection<TimeRange> mandatoryTimes = findMeetingTimes(events, attendees, duration); //[]830-900
    Collection<TimeRange> optionalTimes = findMeetingTimes(events, optional_attendees, duration); //[all day]
